...
4. **Cross-reference** — connect nodes across chapters to capture cross-domain relationships
5. **Annotate freely** — use EXPRESS edges for notes, examples, and metadata
